...
const LikePage = () => {
  const { likeId, imgs } = useContext(UserContext);
  ...
  const deleteProduct = (id) => {
    axios.delete(`https://1c09cdff245b1f0c.mokky.dev/likePage/${id}`).then(() => {
      ...
      {data.map((product) => (
        ...
        >
          ...
          <div>
            ...
            >
              <IoIosHeartEmpty className="bg-red-500 rounded-2xl text-white"/>
            </button>
